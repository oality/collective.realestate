Faceted.MoreOrLessWidget = function(wid){
  this.wid = wid;
...
Faceted.MoreOrLessWidget.prototype = {
...
Faceted.initializeMoreOrLessWidget = function(evt){
  jQuery('div.faceted-moreorless-widget').each(function(){
    var wid = jQuery(this).attr('id');
    wid = wid.split('_')[0];
    Faceted.Widgets[wid] = new Faceted.MoreOrLessWidget(wid);
  });
};
...
jQuery(document).ready(function(){
  jQuery(Faceted.Events).bind(
    ...
    Faceted.initializeMoreOrLessWidget);
});
