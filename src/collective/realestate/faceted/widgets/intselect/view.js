...
Faceted.IntSelectWidget.prototype = {
  ...
  criteria_body: function(){
    ...
    var widget = this;
    var html = jQuery('<dd>');
    var span = jQuery('<span class="facted-intselect-criterion">');
  ...
  count_update: function(data, sortcountable){
    ...
    jQuery(options).each(function(){
      ...
      option.removeClass('faceted-intselect-item-disabled');
      ...
      if(!value){
        ...
        option.addClass('faceted-intselect-item-disabled');
      }
    });
    if(sortcountable){
