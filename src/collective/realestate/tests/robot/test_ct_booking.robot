...
#
#  $ bin/test -s collective.realestate -t test_booking.robot --all
#
...
# 2) Run robot tests:
#
# $ bin/robot /src/collective/realestate/tests/robot/test_booking.robot
#
...
a Booking 'My Booking'
  Create content  type=Real estate  id=my-booking  title=My Booking
